...
public interface BuildService {
     ...
     */
    void build(ImageConfiguration imageConfig) throws JshiftServiceException;
    ...
    class BuildServiceConfig {
        ...
        private io.jshift.kit.build.service.docker.BuildService.BuildContext dockerBuildContext;
        ...
        public io.jshift.kit.build.service.docker.BuildService.BuildContext getDockerBuildContext() {
        ...
        public static class Builder {
            ...
            public Builder dockerBuildContext(io.jshift.kit.build.service.docker.BuildService.BuildContext dockerBuildContext) {
