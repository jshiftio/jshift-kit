...
public class ProfileUtilTest {
    ...
    public void simple() throws IOException {
        InputStream is = getClass().getResourceAsStream("/jshift/config/profiles-lookup-dir/profiles.yaml");
        assertNotNull(is);
    ...
    public void multiple() throws IOException {
        InputStream is = getClass().getResourceAsStream("/jshift/config/ProfileUtilTest-multiple.yml");
        assertNotNull(is);
        List<Profile> profiles = ProfileUtil.fromYaml(is);
    ...
    public File getProfileDir() throws URISyntaxException {
        return new File(getClass().getResource("/jshift/config/profiles-lookup-dir/profiles.yaml").toURI()).getParentFile();
    }
    ...
    public void shouldExtend() throws Exception {
        ...
        assertTrue(aProfile.getEnricherConfig().use("jshift-name"));
