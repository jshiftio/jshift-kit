package io.jshift.kit.build.maven;
...
public class SettingsRegistryAuthHandlerTest {
    ...
    public void testFromSettingsDefault() throws IOException {
        ...
        RegistryAuth config = registryAuthHandler.create(RegistryAuthConfig.Kind.PUSH, "jshiftio", "test.org", s -> s);
        assertNotNull(config);
        verifyAuthConfig(config, "jshiftio", "secret2", "jshiftio@redhat.com");
    }
    ...
    private void setupServers() {
        new Expectations() {{
            ...
            servers.add(create("test.org", "jshiftio", "secret2", "jshiftio@redhat.com"));
